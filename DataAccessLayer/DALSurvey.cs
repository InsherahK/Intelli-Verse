...
namespace DataAccessLayer
{
    ...
    {
        public static void Insertresponse(string userid, string username, string Category, decimal Percentage, int SurveyResponseId)
        {
            ...
            using (SqlConnection con = DBHelper.GetConnection())
            {
                ...
                string insertQuery = "INSERT INTO surveyresult (userid,username, Category, Percentage,SurveyResponseId) " +
                                     "VALUES (@userid,@username, @Category, @Percentage,@SurveyResponseId)";
                ...
                try
                {
                    using (SqlCommand cmd = new SqlCommand(insertQuery, con))
                    {
                        ...
                        cmd.Parameters.AddWithValue("@SurveyResponseId", SurveyResponseId);
        ...
        public static List<Modelsurveyresult> Getsurveyresult()
        {
            ...
            while (sqlDataReaderreader.Read())
            {
                ...
                modelMR.userid = sqlDataReaderreader["userid"].ToString();
                ...
                modelMR.SurveyResponseId = Convert.ToInt32(sqlDataReaderreader["SurveyResponseId"]);
